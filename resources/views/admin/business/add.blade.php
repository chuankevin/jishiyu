        ...
        <form class="form-horizontal" method="post" onsubmit="return check()" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group lv-1" >
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="post_title" placeholder="请输入业务名称" name="post_title">
                    </div>
                </div>
                <div class="form-group lv-1" >
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="post_excerpt" placeholder="请输入一句话介绍" name="post_excerpt">
                    </div>
                </div>
