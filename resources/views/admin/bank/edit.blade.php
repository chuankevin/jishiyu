        ...
        <form class="form-horizontal" method="post" onsubmit="return check()" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group lv-1" >
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" placeholder="请输入银行名称" name="name" value="{{$data->name}}">
                    </div>
                </div>
                <div class="form-group lv-1" >
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="describe" placeholder="请输入银行描述" name="describe" value="{{$data->describe}}">
                    </div>
                </div>
                <div class="form-group lv-2" >
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="link" placeholder="请输入链接" name="link" value="{{$data->link}}">
                    </div>
                </div>
            ...
            <input type="hidden" name="img_path" id="file_url" value="{{$data->icon}}">
            <!-- /.box-body -->
