        ...
        <form class="form-horizontal" method="post" onsubmit="return check()">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="title" placeholder="" name="title" value="{{$data->title}}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="img_url" placeholder="" name="img_url" value="{{$data->img_url}}">
                    </div>
                </div>
