        ...
        <div class="box-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="{{asset('/upload/'.$value->cat_icon)}}" target="_blank"><img src="{{asset('/upload/'.$value->cat_icon)}}" alt="" width="50"></a></td>
                    <td>{{$value->created_at}}</td>
                    <td style="width: 40px">
                        <a href="{{url('admin/productcate/edit')}}?id={{$value->id}}"><button type="button" class="btn btn-block btn-danger btn-sm" >编辑</button></a>
                    </td>
                    <td style="width: 40px">
    ...
    <script>
        ...
        function _delete(id){
            $.ajax({
                ...
                dataType:'json',
                type:'post',
                url:"{{url('admin/productcate/delete')}}",
