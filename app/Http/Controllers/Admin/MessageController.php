...
class MessageController extends HomeController
{
    public function getList(Request $request){
        ...
        $data=$data
            ...
            ->select('message.id as msg_id','message.name','message_type.name as type_name','message_type.icon','amount','repayment_date','message_rep.name as rep_name','message_rem.name as rem_name','remark','message.created_at')
