...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('AdminCreditcard/index');?>"><?php echo L('PORTAL_ADMINCREDITCARD_INDEX');?></a></li>
			...
			<li class="active"><a href="#"><?php echo L('PORTAL_ADMINCREDITCARD_EDIT');?></a></li>
		</ul>
		<form action="<?php echo U('AdminCreditcard/edit_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span9">
					<table class="table table-bordered">
						...
						<tr>
							<th>额度范围</th>
							<td>
								<input type="text" name="post[edufanwei]" style="width: 400px" value="<?php echo ($post['edufanwei']); ?>" placeholder="请输入期限范围">
							</td>
						</tr>
						<tr>
							<th>费率</th>
							<td>
								<input type="text" name="post[feilv]" style="width: 400px" value="<?php echo ($post['feilv']); ?>" placeholder="请输入费率">
							</td>
						</tr>
						<tr>
							<th>期限范围</th>
							<td>
								<input type="text" name="post[qixianfanwei]" style="width: 400px" value="<?php echo ($post['qixianfanwei']); ?>" placeholder="请输入期限范围">
							</td>
						</tr>
						...
						<tr>
							<th>最快放款</th>
							<td>
								<input type="text" name="post[zuikuaifangkuan]" value="<?php echo ($post['zuikuaifangkuan']); ?>" style="width: 400px" placeholder="请输入最快放款">
							</td>
						</tr>
						<tr>
							<th>申请条件</th>
							<td>
								<textarea name="post[shenqingtiaojian]" required style="width: 98%; height: 250px;" placeholder="请填写申请条件"><?php echo ($post["shenqingtiaojian"]); ?></textarea>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							<th>申请地址</th>
							<td>
								<input type="text" name="post[link]" value="<?php echo ($post['link']); ?>" style="width: 400px" placeholder="请输入申请地址">
								<span class="form-required">*</span>
							</td>
						</tr>
						<!--<tr>
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('AdminCreditcard/index');?>">返回</a>
			</div>
		</form>
	</div>
									...
									Wind.use("artDialog", function() {
										art.dialog({
											...
											button : [ {
												...
												name : '返回列表页',
												callback : function() {
													location = "<?php echo U('AdminCreditcard/index');?>";
													return true;
												}
											} ]
										});
